...
reviews_df=pd.read_csv('C:/Users/aaeq8/Desktop/Spring 2020 Courses/KDM_Course/Datasetsfortesting/dataset.csv',error_bad_lines=False)
...
stop_words.extend(['text', 'point','available', 'prize', 'winner', 'jackpot', 'miss', '_', 'free', 'buy', 'purshase', 'money', 'personal', 'urgent'])
